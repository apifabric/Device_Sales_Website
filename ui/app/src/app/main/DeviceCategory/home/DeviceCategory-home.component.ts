...
@Component({
  selector: 'DeviceCategory-home',
  templateUrl: './DeviceCategory-home.component.html',
  styleUrls: ['./DeviceCategory-home.component.scss']
})
export class DeviceCategoryHomeComponent implements AfterViewInit {
