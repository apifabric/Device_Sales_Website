...
@Component({
  selector: 'CategoryAttribute-home',
  templateUrl: './CategoryAttribute-home.component.html',
  styleUrls: ['./CategoryAttribute-home.component.scss']
})
export class CategoryAttributeHomeComponent implements AfterViewInit {
