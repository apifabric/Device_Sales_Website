...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.CategoryAttribute, method_decorators= method_decorators)
    api.expose_object(database.models.DeviceCategory, method_decorators= method_decorators)
