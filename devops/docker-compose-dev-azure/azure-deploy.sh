...
resourcename="devicesaleswebsite"  # lower case, only
resourcegroup="devicesaleswebsite_rg"
...
# git clone https://github.com/apilogicserver/devicesaleswebsite.git
# cd devicesaleswebsite
...
az group create --name devicesaleswebsite_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group devicesaleswebsite_rg --sku S1 --is-linux
az container create --resource-group devicesaleswebsite_rg --name devicesaleswebsite --image apilogicserver/devicesaleswebsite:latest --dns-name-label devicesaleswebsite --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//devicesaleswebsite.westus.azurecontainer.io:5656'
